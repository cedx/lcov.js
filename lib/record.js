...
const {BranchCoverage} = require('./branch');
const {FunctionCoverage} = require('./function');
const {LineCoverage} = require('./line');
...
exports.Record = class Record {
   ...
   */
  static fromJson(map) {
    return !map || typeof map != 'object' ? null : new Record(typeof map.sourceFile == 'string' ? map.sourceFile : '', {
