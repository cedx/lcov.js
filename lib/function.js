...
export class FunctionData {
	 ...
	 * @param {Record<string, unknown>} map A JSON object representing a function data.
	...
	static fromJson(map) {
		return new FunctionData({
			...
			functionName: typeof map.functionName == "string" ? map.functionName : "",
...
export class FunctionCoverage {
	 ...
	 * @param {Record<string, unknown>} map A JSON object representing a function coverage.
	 * @returns {FunctionCoverage} The instance corresponding to the specified JSON object.
	 */
	static fromJson(map) {
		return new FunctionCoverage({
			data: Array.isArray(map.data) ? map.data.map(item => FunctionData.fromJson(item)) : [],
