...
export class File {
	...
	/**
	 * Creates a new file from the specified JSON object.
	 * @param {Record<string, any>} map A JSON object representing a file.
	 * @returns {File} The instance corresponding to the specified JSON object.
	 */
	static fromJson(map) {
