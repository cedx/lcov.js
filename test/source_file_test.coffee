...
describe "SourceFile", ->
	describe "fromJson()", ->
		...
		it "should return an initialized instance for a non-empty map", ->
			record = SourceFile.fromJson branches: {}, functions: {}, lines: {}, path: "/home/cedx/lcov.js"
	...
	describe "toString()", ->
		it "should return a format like 'SF:<path>\\nend_of_record'", ->
			...
			record = new SourceFile "/home/cedx/lcov.js", branches: new BranchCoverage, functions: new FunctionCoverage, lines: new LineCoverage
